...
# Create DataLoader with MemoryCache backend and lock provider
loader = DataLoader(batch_load_fn=batch_fetch_stock_prices, backend=cache_backend, get_named_lock=get_named_lock)
